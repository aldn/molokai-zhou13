...
let g:colors_name="molokai-zhou13"
...
if exists("g:molokai_terminal") && g:molokai_terminal == 1
    ...
    hi SpecialKey ctermfg=14 cterm=bold

    hi MatchParen ctermbg=3 cterm=bold
    ...
    hi Tag ctermfg=9
    hi Todo ctermfg=15 ctermbg=bg cterm=bold
